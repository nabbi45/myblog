...
urlpatterns = [
    ...
    path('', home_page),
    path('blog-new/',blog_post_create_view), #stayed here because it is run before include urls.
    ...
    #re_path can fetch path('page/',about_page), and path('pages/',about_page), as well
    path('about/',about_page),
    path('contact/',contact_page),
    path('admin/', admin.site.urls),
]

if settings.DEBUG:  #test mode. Not live production server
